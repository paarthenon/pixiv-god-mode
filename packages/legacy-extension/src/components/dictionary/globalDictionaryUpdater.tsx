...
export class GlobalDictionaryUpdater extends React.Component<
    {mode: GlobalDictUpdateState; updateAction: Function},
    {}
> {
            ...
            <Bootstrap.InputGroup>
                ...
                {this.props.mode === GlobalDictUpdateState.AVAILABLE ? (
                    <Bootstrap.InputGroup.Button>
                        <Bootstrap.Button onClick={() => this.props.updateAction()}>
                            Update Dictionary
                        </Bootstrap.Button>
                    </Bootstrap.InputGroup.Button>
                ) : null}
