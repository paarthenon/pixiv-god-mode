                    ...
                    <Bootstrap.InputGroup.Button style={{width: 'auto'}}>
                        <Bootstrap.Dropdown id='pa-download-dropdown'>
                            ...
                            <Bootstrap.Dropdown.Menu>
                                ...
                                <Bootstrap.MenuItem
                                    eventKey='2'
                                    disabled={!this.props.serverConnected}
                                    onClick={() => this.props.downloadUsingServer()}
                                >
                                    Download w/ Server
                                </Bootstrap.MenuItem>
                            </Bootstrap.Dropdown.Menu>
                        ...
                        <Bootstrap.Button
                            disabled={
                                !(
                                    this.props.serverConnected &&
                                    this.props.mode === DownloadStates.DOWNLOADED
                                )
                            }
...
export class IllustrationToolbarContainer extends React.Component<
    IllustrationToolbarContainerProps,
    ContainerState
> {
    protected patchState<Sub, Full extends Sub & ContainerState>(
        original: Full,
        sub: Sub,
    ) {
