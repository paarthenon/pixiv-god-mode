...
import {GlobalDictUpdateState, GlobalDictionaryUpdater} from 'src/components/dictionary/globalDictionaryUpdater'
...
export class GlobalDictUpdaterContainer extends React.Component<{}, {mode: GlobalDictUpdateState, dupeLocalKeys:string[]}> {
	...
	public render() {
		return <div>
			<GlobalDictionaryUpdater mode={this.state.mode} updateAction={this.updateDictionary.bind(this)} />
			<DuplicateKeyReporter dupes={this.state.dupeLocalKeys} removeAction={this.removeDuplicates.bind(this)} />
		</div>
	}
}